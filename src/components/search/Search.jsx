...
const Search = () => {
  ...
  const activeClear =
    textQuery.length > 0 ? styles["search-clear"] : styles["search-none"];
    ...
    <div className={styles["header-search"]}>
      <div className={styles["search-input"]}>
        <motion.input
          ...
          whileFocus={{ width: "600px", fontSize: "16px" }}
          type="text"
        ></motion.input>
        <button className={activeClear} onClick={clearHandler}>
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          >
            <g id="Icon" clipPath="url(#clip0_235_948)">
              <path
                id="Vector"
                d="M19 6.415L17.59 5.005L12 10.595L6.41 5.005L5 6.415L10.59 12.005L5 17.595L6.41 19.005L12 13.415L17.59 19.005L19 17.595L13.41 12.005L19 6.415Z"
                fill="black"
                fillOpacity="0.87"
              />
            </g>
      ...
      <NavLink to="/search" className={activeBtn} onClick={sendSearchRequest}>
        <svg
          width="25"
          height="25"
          viewBox="0 0 25 25"
          ...
          <defs>
            <clipPath id="clip0_235_943">
              <rect
                ...
                height="24"
                fill="white"
                transform="translate(0.666687 0.334961)"
              />
            </clipPath>
          </defs>
        </svg>
