...
const GeneralSection = ({ category, number, clName }) => {
    ...
    const {loading, error, sendHttpRequest} = useGetRequest(`https://gnews.io/api/v4/top-headlines?category=${category}&apikey=caff4ea3f88849a0348df3f99a491fd2&lang=ru&max=${number}`);
    ...
    return <>
    {loading ? <Loader /> : <section className={styles[clName]}>
    {items}
    </section>}
    </>
}
